...
$config['authentication'] = function () {
    require $_SERVER['DOCUMENT_ROOT'] . '/laravel/Laravel-site/vendor/autoload.php';
    $app = require_once  $_SERVER['DOCUMENT_ROOT']. '/laravel/Laravel-site/bootstrap/app.php';
